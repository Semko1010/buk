	...
	return (
		<section
			...
			<div className='text-center w-full'>
				<h2 className='md:inline hidden  md:font-light md:leading-none md:text-res  text-[37px] uppercase leading-[39px] text-headingColor'>
					EIN GROSSER DANK <br /> GILT UNSEREN <br />
					SPONSOREN
				</h2>
			</div>
			<p className='md:mx-[40px] md:mt-[42px] mx-[15px] mt-[30px] text-fontColorPrimary leading-[23px] font-medium'>
			...
			<div>
				<h2 className='md:mx-[40px] border-b pb-[18px]  text-[25px] leading-[27px] text-fontColorPrimary mt-20 mx-[15px]'>
					Gold <br />
					Sponsoren
				</h2>
				<div className='md:ml-[40px] md:flex md:flex-wrap ml-[15px]'>
					<img
			...
			<div className='mt-[100px]'>
				<h2 className='md:ml-[40px] border-b pb-[18px]  text-[25px] leading-[27px] text-fontColorPrimary  mx-[15px]'>
					Silber <br />
					Sponsoren
				</h2>
			...
			<div className='md:mx-[40px] mt-[100px]'>
